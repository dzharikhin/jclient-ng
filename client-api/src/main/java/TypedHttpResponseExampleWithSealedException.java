...
//то же, что и TypedHttpResponse с поправками на вариант с sealed исключениями
public interface TypedHttpResponseExampleWithSealedException<T, E extends RuntimeException> {
    int statusCode();
    HttpHeaders headers();
    Either<T, E> body();
    URI uri();
